#ifndef _PRIMITIVE_SPHERICAL_SURFACE_H_
#define _PRIMITIVE_SPHERICAL_SURFACE_H_

#include "primitive/surface_primitive.h"

namespace primitive {

class SphericalSurface : public SurfacePrimitive {
public:
  SphericalSurface();
  SphericalSurface(const Eigen::Vector3d& center, const double radius);
